...
namespace AssignmentCsharp4_hieuptph18134.Controllers
{
    public class HoaDonsController : Controller
    {
        ...
        public HoaDonsController(AsmContext context)
        {
            _context = context;
        }
        ...
        {
            var assignmentCsharp4Context = _context.HoaDons.Include(h => h.MaKhachHangNavigation);
        ...
        public async Task<IActionResult> Create([Bind("MaHoaDon,MaKhachHang,NgayBan")] HoaDon hoaDon)
        {
            if (ModelState.IsValid)
            {
                _context.Add(hoaDon);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("MaHoaDon,MaKhachHang,NgayBan")] HoaDon hoaDon)
        {
